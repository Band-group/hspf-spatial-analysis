...
import { PfsaCounts, PixelCoords, LatLong, Country, colours, PfsaDataKey } from './Types.js' ;
...
export default class ComparisonDisplay {
	...
	constructor(
		...
		elt: SVGElement,
		plot_name: string,
		y_column_name: PfsaDataKey,
		N_column_name: PfsaDataKey,
		limit: number,
		geom: Geom = {
			'width': 1000,
			'height': 700,
		...
		this.scales = {
			...
			fill: (country: Country) => colours[country] || colours['other']
		} ;
