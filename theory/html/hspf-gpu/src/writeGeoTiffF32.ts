...
function endsWith(string: string, expectedEnding: string) {
...
function times( numTimes: number, func ) {
	const results = [];
...
export function writeGeotiffF32(data: Int32Array, metadata) {
